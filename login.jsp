...
<body class="" 
style="background-image: url(./images/full_screenlogin.jpeg) !important;  background-repeat: no-repeat;
background-size: cover;" onload="checkSessionKey()"> <!--  Contenedor 100 vw -->
      ...
      <div class="row">
        ...
        <div class="col-6 d-none d-lg-block">
            <div class="row d-none d-lg-block">
                <div class="col-12 d-none d-lg-block" style="padding: 5em; ">
        ...
        <div class="col-12 col-lg-6" style="padding: 0">
            ...
            <div class="row ">
                <div class="col-12 container-card d-flex justify-content-center" >
                    ...
                    <div class="card" style="border-radius: 2em !important;max-height: 80vh; overflow: hidden;"> <!-- Segmento de formulario, un CARD -->
                        ...
                        <div class="container">
                            ...
                            <div class="theme-icon inline auto transparent product-logo portal-logo">
                                <img src="./images/fashions-park-logo.png" class="img-fluid imagen-logo-fsp" alt="product-logo"  />
                            </div> 
